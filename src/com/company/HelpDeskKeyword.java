...
public class HelpDeskKeyword {
    ...
    public static void main(String[] args) {
        ...
        //similarityList.stream().forEach(System.out::println);

        Map<String,Double> detailOneSimilarityMap = detailSimilarity(column7List,similarityList);
        detailOneSimilarityMap.entrySet().stream().forEach(System.out::println);
        ...
        for (String str : distinctWordSet) {
            ...
            for (int i = 0; i < columnList.size(); i++) {
                if (columnList.get(i).contains(str)){
                    ...
                    double result = Math.round(count/ data.size() * 100)/100.0;
    ...
    public static Map<String,Double> detailSimilarity(List<String> columnList, List<Map.Entry<String,Double>> similarityWordList){
        ...
        for (int i = 0; i < 20; i++) {
            ...
            List<Map.Entry<String,Double>> list = checkSimilarity(columnList,set);
